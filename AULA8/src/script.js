...
let frase = 'Eu gosto de Ferrari. Ferrari são muito bonitas';

frase = frase.replaceAll('Ferrari', 'Motos');
...
//Utilização dos métodos indexOf(), lastIndexOf() search()
...
let nome = 'Nathan Marques';
let exEndsWith = nome.endsWith('Marques');
